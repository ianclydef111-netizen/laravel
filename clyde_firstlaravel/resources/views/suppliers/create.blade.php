...
<div class="card">
    <div class="card-body">
        <div class="d-flex justify-content-between">
            <h5><i class="fa fa-plus-circle me-2"></i>Add Supplier</h5>
        ...
        <form method="POST" action="{{ route('suppliers.store') }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control bg-light" readonly value="SUP{{ str_pad(rand(1,999), 3, '0', STR_PAD_LEFT) }}">
            ...
            <div class="row g-3 mt-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="contact_no" class="form-control @error('contact_no') is-invalid @enderror" value="{{ old('contact_no') }}" required>
                </div>
                <div class="col-md-6">
